...
<link rel="stylesheet" href="css/style_navegation.css">
    ...
    <head>
        ...
        <script src="JavaScript-JQuery/Ofertes.js" defer></script>
...
<script src="Ajax/LlistatOfertes.js" defer></script>
...
<div class="container-fluid ">
    <div class="row justify-content-center">
        <div class="col-md-4 center-block">
            <div class="card-img-top bg-secondary m-3 caixa">
                <img class="w-100 imatge">
            <div class="p-2">
                <span class="psw"><a class="enllac" data-numero="1"></a></span>
                <br>
                <p class="data"></p>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-4 d-flex justify-content-center">
            <div class="card-img-top bg-secondary m-3 caixa">
                    <img class="w-100 imatge">
               <div class="oferta">
                    <span class="psw"><a class="enllac" data-numero="2"></a></span>
                    <br>
                   <p class="data"></p>
                </div>
            </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card-img-top bg-secondary m-3 caixa">
                    <img class="w-100 imatge">
                <div class="oferta">
                    <span class="psw"><a class="enllac" data-numero="3"></a></span>
                    <br>
                    <p class="data"></p>
                </div>
            </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card-img-top bg-secondary m-3 caixa">
                    <img class="w-100 imatge">
                <div class="oferta">
                    <span class="psw"><a class="enllac" data-numero="4"></a></span>
                    <br>
                    <p class="data"></p>
                </div>
            </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card-img-top bg-secondary m-3 caixa">
                    <img class="w-100 imatge">
                <div class="oferta">
                    <span class="psw"><a class="enllac" data-numero="5"></a></span>
                    <br>
                    <p class="data"></p>
                </div>
            </div>
