...
<head>
    ...
    <script src="Ajax/ofertaActiva.js" defer></script>
...
<div class="container">
    <div class="row d-sm-flex">
        <div class="col">
            <div class="m-5">
                <img class="w-70" id="imatge" alt="Avatar">
            </div>
        </div>
        <div class="col mt-3">
            <div class="ms-5 justify-content-center h3">
                <p id="titolOferta"></p>
            </div>
            <div class="mt-5 justify-content-center h5">
                <ul class="p-2">
                    <li id="localitzacio" class="llistat"></li>
                    <li id="salari"></li>
                </ul>
            </div>
        </div>
    ...
    <div class="accordion" id="accordionExample">
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body" id="descripcio">
                </div>
            </div>
        </div>
        <div class="accordion-item">
